CREATE DATABASE  IF NOT EXISTS `bdadm` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `bdadm`;
...
INSERT INTO `usuario` (`nome`, `sobrenome`, `email`, `matricula`, `senha`, `username`) VALUES ('poli', 'antunes', 'anderantunes@yahoo', '123', 'teste2', 'poli');
COMMIT;

-- UPDATE usuario SET nome='poliana' where id = '2';


USE `bdadm`;
SELECT * FROM usuario;
DELETE FROM usuario WHERE id = ''; 
UPDATE usuario SET matricula='67146198' where id = '2';
--
...
-- Dump completed on 2019-08-22  9:15:14
